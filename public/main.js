...
$(document).ready(function(){
  ...
  var test1 = new teamObject("test1",1,12,0,.23,233,255);
  var test2 = new teamObject("test2",1,12,0,.23,233,255);
  var test3 = new teamObject("test3",1,12,0,.23,233,255);
  var test4 = new teamObject("test4",1,12,0,.23,233,255);
  var somedata = [];
  somedata.push(test1);
  somedata.push(test2);
  somedata.push(test3);
